class AwsHelper::EC2Instance
	...
	def stop(instance_id)
		begin
		  ...
		  case state.code
		  when 0  # pending
		  	return {error: {code: state.name, message: I18n.t("aws.ec2.errors.instance_pending", instance_id: instance_id)}}		    
		  when 32  # shutting-down
		    return {error: {code: state.name, message: I18n.t("aws.ec2.errors.instance_shutting_down", instance_id: instance_id)}}
		  when 48  # terminated
		    return {error: {code: state.name, message: I18n.t("aws.ec2.errors.instance_terminated", instance_id: instance_id)}}
		  when 64  # stopping
		    return {error: {code: state.name, message: I18n.t("aws.ec2.errors.instance_stopping", instance_id: instance_id)}}
		  when 80  # stopped
		    return {error: {code: state.name, message: I18n.t("aws.ec2.errors.instance_stopped", instance_id: instance_id)}}
		  else
	...
	def start(instance_id)
		begin
		  ...
		  when 32  # shutting-down
		    return {error: {code: state.name, message: I18n.t("aws.ec2.errors.instance_shutting_down", instance_id: instance_id)}}
		  when 16  # started
		    return {error: {code: state.name, message: I18n.t("aws.ec2.errors.instance_started", instance_id: instance_id)}}
		  when 48  # terminated
		    return {error: {code: state.name, message: I18n.t("aws.ec2.errors.instance_terminated", instance_id: instance_id)}}
		  else
			...
			return {error: {code: I18n.t("aws.common.codes.incorrect_instance_state"), message: e.message}, result: []}
	  rescue Exception => e
			return {error: {code: I18n.t("aws.common.codes.custom_exception"), message: I18n.t("aws.common.errors.custom_exception")}}
		end
	end	
	...
	def validate_instance(instance)
		begin
			...
			return {error: {code: I18n.t("aws.common.codes.invalid_instance"), message: e.message}}
		rescue Exception => e
			return {error: {code: I18n.t("aws.common.codes.custom_exception"), message: I18n.t("aws.common.errors.custom_exception")}}
		end
	end
